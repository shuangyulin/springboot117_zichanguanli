<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资产编号" prop="zichanbianhao">
          <el-input v-model="ruleForm.zichanbianhao" 
              placeholder="资产编号" clearable  :readonly="ro.zichanbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资产编号" prop="zichanbianhao">
              <el-input v-model="ruleForm.zichanbianhao" 
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zichantupian" label="资产图片" prop="zichantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zichantupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="归还备注" prop="guihaibeizhu">
          <el-input v-model="ruleForm.guihaibeizhu" 
              placeholder="归还备注" clearable  :readonly="ro.guihaibeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="归还备注" prop="guihaibeizhu">
              <el-input v-model="ruleForm.guihaibeizhu" 
                placeholder="归还备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zichanguihai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zichanguihaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
