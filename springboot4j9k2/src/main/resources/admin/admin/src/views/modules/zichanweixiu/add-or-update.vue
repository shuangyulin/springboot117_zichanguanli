<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="资产编号" prop="zichanbianhao">
          <el-select  @change="zichanbianhaoChange" v-model="ruleForm.zichanbianhao" placeholder="请选择资产编号">
            <el-option
                v-for="(item,index) in zichanbianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.zichanbianhao" label="资产编号" prop="zichanbianhao">
              <el-input v-model="ruleForm.zichanbianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资产分类" prop="zichanfenlei">
          <el-input v-model="ruleForm.zichanfenlei" 
              placeholder="资产分类" clearable  :readonly="ro.zichanfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资产分类" prop="zichanfenlei">
              <el-input v-model="ruleForm.zichanfenlei" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="维修说明" prop="weixiushuoming">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.weixiushuoming" label="维修说明" prop="weixiushuoming">
                    <span>{{ruleForm.weixiushuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/zichanxinxi/zichanbianhao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.zichanbianhaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    zichanbianhaoChange () {
      this.$http({
        url: `follow/zichanxinxi/zichanbianhao?columnValue=`+ this.ruleForm.zichanbianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              ...
              if(data.data.zichanfenlei){
                this.ruleForm.zichanfenlei = data.data.zichanfenlei
              }
    ...
    onSubmit() {
      ...
      if(parseInt(this.ruleForm.weixiushuliang)>parseInt(this.ruleForm.shuliang)){
        this.$message.error("维修数量不能超过数量");
        return
      }
